    ...
    def train(self):
        ...
        with tf.variable_scope('global_scope') as scope:
            ...
            for i, (g,v) in enumerate(grads_vars):
                if g is not None:
                    grads_vars[i] = (tf.clip_by_norm(g,args.clip_grads_max),v)
        ...
        for batch_i in range(args.batch_num):
            ...
            _,loss_value,total_loss_value,logits_value_train,summary_val = sess.run([train_op,loss,total_loss,logits,summary],feed_dict=feed_dict)
